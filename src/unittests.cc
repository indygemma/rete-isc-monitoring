...
TEST_CASE( "Adding a condition to alpha memory" ) {/* {{{*/
    rete::condition_t c1(rete::var("test"), rete::var("x"), rete::value_string("lol"));
...
TEST_CASE( "Adding two seperate conditions to alpha memory" ) {/* {{{*/
    rete::condition_t c1(rete::var("test"), rete::var("x"),     rete::value_string("lol"));
    rete::condition_t c2(rete::var("test"), rete::attr("name"), rete::value_string("lol"));
...
TEST_CASE( "Add a single rule" ) {/* {{{*/
    ...
    rete::condition_t conditions[2] = {
        rete::condition_t(rete::var("test"), rete::var("x"),     rete::value_string("lol")),
        rete::condition_t(rete::var("test"), rete::attr("name"), rete::value_string("lol"))
    };
